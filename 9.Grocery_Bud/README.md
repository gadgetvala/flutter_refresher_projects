[![support](https://img.shields.io/badge/plateform-flutter%7Candroid%20studio-9cf?style=plastic&logo=appveyor)](https://github.com/gadgetvala/flutter_refresher_projects)
...
> “Grocery_Bud”
> is a small, simple and beautiful app for taking note.
...
- [x] Sleek Design.
- [x] State Management.
- [x] Create List, Update List, Delete List
...
$ cd flutter_refresher_projects/8.Color_Generator
...
Feel free to **file a new issue** with a respective title and description on the the [9.Grocery_Bud](https://github.com/gadgetvala/flutter_refresher_projects/issues) repository. If you already found a solution to your problem, **I would love to review your pull request**!
